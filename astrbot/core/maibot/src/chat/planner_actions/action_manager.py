...
from astrbot.core.maibot.src.plugin_system.base.component_types import ComponentType, ActionInfo
from astrbot.core.maibot.src.plugin_system.base.base_action import BaseAction
