...
from astrbot.core.maibot.src.plugin_system.base.component_types import ActionInfo, ComponentType, ActionActivationType
from astrbot.core.maibot.src.plugin_system.core.component_registry import component_registry
...
if TYPE_CHECKING:
    from astrbot.core.maibot.src.common.data_models.info_data_model import TargetPersonInfo
