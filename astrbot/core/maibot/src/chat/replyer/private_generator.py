...
from astrbot.core.maibot.src.common.data_models.database_data_model import DatabaseMessages
from astrbot.core.maibot.src.common.data_models.info_data_model import ActionPlannerInfo
from astrbot.core.maibot.src.common.data_models.llm_data_model import LLMGenerationDataModel
...
from astrbot.core.maibot.src.chat.message_receive.message import UserInfo, Seg, MessageRecv, MessageSending
from astrbot.core.maibot.src.chat.message_receive.chat_stream import ChatStream
from astrbot.core.maibot.src.chat.message_receive.uni_message_sender import UniversalMessageSender
from astrbot.core.maibot.src.chat.utils.timer_calculator import Timer  # <--- Import Timer
from astrbot.core.maibot.src.chat.utils.utils import get_chat_type_and_target_info, is_bot_self
from astrbot.core.maibot.src.chat.utils.prompt_builder import global_prompt_manager
from astrbot.core.maibot.src.chat.utils.chat_message_builder import (
    build_readable_messages,
    get_raw_msg_before_timestamp_with_chat,
    replace_user_references,
)
from astrbot.core.maibot.src.bw_learner.expression_selector import expression_selector
from astrbot.core.maibot.src.plugin_system.apis.message_api import translate_pid_to_description

# from astrbot.core.maibot.src.memory_system.memory_activator import MemoryActivator

from astrbot.core.maibot.src.person_info.person_info import Person, is_person_known
from astrbot.core.maibot.src.plugin_system.base.component_types import ActionInfo, EventType
from astrbot.core.maibot.src.plugin_system.apis import llm_api

from astrbot.core.maibot.src.chat.replyer.prompt.lpmm_prompt import init_lpmm_prompt
from astrbot.core.maibot.src.chat.replyer.prompt.replyer_private_prompt import init_replyer_private_prompt
...
from astrbot.core.maibot.src.bw_learner.jargon_explainer import explain_jargon_in_context
...
class PrivateReplyer:
    def __init__(
        ...
        from astrbot.core.maibot.src.plugin_system.core.tool_use import ToolExecutor  # 延迟导入ToolExecutor，不然会循环依赖
    ...
    async def get_prompt_info(self, message: str, sender: str, target: str):
        related_info = ""
        start_time = time.time()
        from astrbot.core.maibot.src.plugins.built_in.knowledge.lpmm_get_knowledge import SearchKnowledgeFromLPMMTool
