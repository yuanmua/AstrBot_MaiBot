...
from astrbot.core.maibot.src.plugins.memory_system.Hippocampus import HippocampusManager
...
from astrbot.core.maibot.src.chat.message_receive.message import Message
from astrbot.core.maibot.src.chat.knowledge.knowledge_lib import qa_manager
