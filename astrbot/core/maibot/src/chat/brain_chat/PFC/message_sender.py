...
from astrbot.core.maibot.src.common.logger import get_module_logger
from astrbot.core.maibot.src.chat.message_receive.chat_stream import ChatStream
from astrbot.core.maibot.src.chat.message_receive.message import Message, MessageSending
...
class DirectMessageSender:
    ...
    async def send_message(
        ...
        try:
            ...
            # 发送消息（直接调用底层 API）
            from astrbot.core.maibot.src.chat.message_receive.uni_message_sender import _send_message
