...
from astrbot.core.maibot.src.chat.message_receive.message import MessageSending
from astrbot.core.maibot.src.chat.message_receive.storage import MessageStorage
from astrbot.core.maibot.src.chat.utils.utils import truncate_message
from astrbot.core.maibot.src.chat.utils.utils import calculate_typing_time
...
def get_webui_chat_broadcaster():
    ...
    if _webui_chat_broadcaster is None:
        try:
            from astrbot.core.maibot.src.webui.chat_routes import chat_manager, WEBUI_CHAT_PLATFORM
