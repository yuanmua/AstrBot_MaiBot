...
# 导入新插件系统
from astrbot.core.maibot.src.plugin_system import BasePlugin, register_plugin, ComponentInfo
...
from astrbot.core.maibot.src.plugins.built_in.emoji_plugin.emoji import EmojiAction
