...
# 导入新插件系统
from astrbot.core.maibot.src.plugin_system import BaseAction, ActionActivationType

# 导入依赖的系统组件
from astrbot.core.maibot.src.common.logger import get_logger

# 导入API模块 - 标准Python包方式
from astrbot.core.maibot.src.plugin_system.apis import emoji_api, llm_api, message_api
