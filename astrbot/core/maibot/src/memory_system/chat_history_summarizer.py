...
from astrbot.core.maibot.src.plugin_system.apis import message_api
from astrbot.core.maibot.src.chat.utils.chat_message_builder import build_readable_messages
from astrbot.core.maibot.src.chat.utils.utils import is_bot_self
...
class ChatHistorySummarizer:
    ...
    async def _store_to_database(
        ...
        try:
            ...
            from astrbot.core.maibot.src.plugin_system.apis import database_api
