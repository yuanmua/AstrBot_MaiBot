...
# from astrbot.core.maibot.src.common.remote import TelemetryHeartBeatTask
from astrbot.core.maibot.src.manager.async_task_manager import async_task_manager
from astrbot.core.maibot.src.chat.utils.statistic import OnlineTimeRecordTask, StatisticOutputTask

# from astrbot.core.maibot.src.chat.utils.token_statistics import TokenStatisticsTask
from astrbot.core.maibot.src.chat.emoji_system.emoji_manager import get_emoji_manager
...
from astrbot.core.maibot.src.common.server import get_global_server, Server
from astrbot.core.maibot.src.chat.knowledge import lpmm_start_up
from rich.traceback import install

# from astrbot.core.maibot.src.api.main import start_api_server

# 导入新的插件管理器
from astrbot.core.maibot.src.plugin_system.core.plugin_manager import plugin_manager

# 导入消息API和traceback模块
from astrbot.core.maibot.src.common.message import get_global_api
from astrbot.core.maibot.src.dream.dream_agent import start_dream_scheduler
from astrbot.core.maibot.src.bw_learner.expression_auto_check_task import ExpressionAutoCheckTask
...
class MainSystem:
    ...
    def _setup_webui_server(self):
        ...
        try:
            from astrbot.core.maibot.src.webui.webui_server import get_webui_server
