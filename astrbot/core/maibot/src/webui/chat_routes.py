...
from astrbot.core.maibot.src.common.database.database_model import Messages, PersonInfo
...
from astrbot.core.maibot.src.webui.ws_auth import verify_ws_token
