...
使用方式：
    from astrbot.core.maibot.src.plugin_system.apis import generator_api
...
from astrbot.core.maibot.src.chat.replyer.group_generator import DefaultReplyer
from astrbot.core.maibot.src.chat.replyer.private_generator import PrivateReplyer
from astrbot.core.maibot.src.chat.message_receive.chat_stream import ChatStream
from astrbot.core.maibot.src.chat.utils.utils import process_llm_response
from astrbot.core.maibot.src.chat.replyer.replyer_manager import replyer_manager
from astrbot.core.maibot.src.plugin_system.base.component_types import ActionInfo
