...
使用方式：
    from astrbot.core.maibot.src.plugin_system.apis import send_api
...
from astrbot.core.maibot.src.chat.message_receive.message import MessageSending, MessageRecv
...
if TYPE_CHECKING:
    ...
    from astrbot.core.maibot.src.common.data_models.message_data_model import ReplySetModel, ReplyContent, ForwardNode
