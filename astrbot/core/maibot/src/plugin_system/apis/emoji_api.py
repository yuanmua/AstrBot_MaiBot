...
使用方式：
    from astrbot.core.maibot.src.plugin_system.apis import emoji_api
...
from astrbot.core.maibot.src.chat.emoji_system.emoji_manager import get_emoji_manager, EMOJI_DIR
from astrbot.core.maibot.src.chat.utils.utils_image import image_path_to_base64, base64_to_image
