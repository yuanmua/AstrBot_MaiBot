...
from astrbot.core.maibot.src.plugin_system.base.config_types import (
    ConfigField,
    ConfigSection,
    ConfigLayout,
)
from astrbot.core.maibot.src.plugin_system.utils.manifest_utils import ManifestValidator
