...
from astrbot.core.maibot.src.chat.message_receive.message import MessageRecv, MessageSending
...
from astrbot.core.maibot.src.plugin_system.base.component_types import EventType, EventHandlerInfo, MaiMessages, CustomEventHandlerResult
from astrbot.core.maibot.src.plugin_system.base.base_events_handler import BaseEventHandler
...
class EventsManager:
    ...
    async def handle_mai_events(
        ...
        """
        from astrbot.core.maibot.src.plugin_system.core import component_registry
