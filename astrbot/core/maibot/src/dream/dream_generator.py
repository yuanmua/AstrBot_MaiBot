...
from astrbot.core.maibot.src.chat.utils.prompt_builder import Prompt
from astrbot.core.maibot.src.llm_models.payload_content.message import RoleType, Message
