...
from astrbot.core.maibot.src.common.database.database_model import ChatHistory
from astrbot.core.maibot.src.chat.utils.prompt_builder import Prompt, global_prompt_manager
from astrbot.core.maibot.src.llm_models.payload_content.message import MessageBuilder, RoleType, Message
from astrbot.core.maibot.src.plugin_system.apis import llm_api
from astrbot.core.maibot.src.dream.dream_generator import generate_dream_summary

# dream 工具工厂函数
from astrbot.core.maibot.src.dream.tools.search_chat_history_tool import make_search_chat_history
from astrbot.core.maibot.src.dream.tools.get_chat_history_detail_tool import make_get_chat_history_detail
from astrbot.core.maibot.src.dream.tools.delete_chat_history_tool import make_delete_chat_history
from astrbot.core.maibot.src.dream.tools.create_chat_history_tool import make_create_chat_history
from astrbot.core.maibot.src.dream.tools.update_chat_history_tool import make_update_chat_history
from astrbot.core.maibot.src.dream.tools.finish_maintenance_tool import make_finish_maintenance
from astrbot.core.maibot.src.dream.tools.search_jargon_tool import make_search_jargon
from astrbot.core.maibot.src.dream.tools.delete_jargon_tool import make_delete_jargon
from astrbot.core.maibot.src.dream.tools.update_jargon_tool import make_update_jargon
